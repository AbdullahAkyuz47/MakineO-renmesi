...
# LogisticRegression modelinin tanımlanması ve eğitilmesi
...
# Multinominal Lojistik Regresyon modeli ile tahminler yapma
logistic_predictions_test = logistic_reg.predict(X_test)

# Doğruluk oranını hesaplama
logistic_accuracy_test = accuracy_score(y_test, logistic_predictions_test)

print("Multinominal Lojistik Regresyon Test Seti Doğruluk Oranı:", logistic_accuracy_test)
...
# Çoklu Doğrusal Regresyon modeli ile tahminler yapma
...
print("Çoklu Doğrusal Regresyon Test Seti Ortalama Kare Hata (MSE):", linear_mse_test)
